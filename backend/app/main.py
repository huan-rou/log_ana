...
from app.api import auth, mapping, reports, purpose_executions
...
app.include_router(purpose_executions.router, prefix="/api/purpose-executions", tags=["purpose-executions"])
